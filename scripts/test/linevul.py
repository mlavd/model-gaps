...
if __name__ == '__main__':
    ...
    # Run it
    subprocess.run([
        'python', f'{base}/models/linevul/linevul_main.py',
        f'--output_dir={base}/models/linevul/saved_models/{args.train}',
        '--model_type=roberta',
        ...
        f'--predictions={base}/logs/predictions/linevul_{args.train}_on_{args.test}.txt',
        '--block_size=512',
        '--eval_batch_size=32',
        '--seed=42',
    ])
